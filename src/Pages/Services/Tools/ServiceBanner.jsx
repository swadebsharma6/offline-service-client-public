...
import img3 from "../../../assets/images/banner/banner-2.jpg";

const ServiceBanner = ({handleSearching}) => {

   


  return (
    <section className="md:h-[350px]">
      <div className="relative h-full w-full ">
        <img src={img3} alt="image 1" className="h-full w-full object-cover" />
            ...
            >
              <div className="relative flex h-10 w-full min-w-[200px] max-w-[24rem]">
                <input
                  ...
                  name="serviceName"
                  id="search"
                  className="peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 pr-20 font-sans text-sm font-normal text-white outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-gray-400"
